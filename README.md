...
```bash
gemini extensions install https://github.com/GGGLHHH/superpowers
```
...
6. **finishing-a-development-branch** - Activates when tasks complete. Verifies tests, presents options (merge/PR/keep/discard), then stops for the user to choose how to integrate the work.
